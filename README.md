...
[https://github.com/ArikRahman/dotfiles](https://github.com/ArikRahman/dotfiles)
...
- **`AGENTS.md`**: Context and instructions for AI agents working on this project.
- **`Appendix.md`**: Personal notes and appendix (not for editing by agents).
...
- For development, follow the Manus workflow as described in `AGENTS.md` for complex tasks.
